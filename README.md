...
Exercise:
Make your code a public github.com repository. 
 
Build a site in javascript similar to https://giphy.com/ using their API: https://developers.giphy.com/  No need to worry about design or styles, just getting the functionality.  
Requirements:
Displays trending gifs on page load in a grid
Input field for search
Should update the search as they type
At the bottom of the search results add a 'more' link that will retrieve more gifs from the API
Feel free to use any tools/resources you choose and let me know if you have any questions/comments.
...
### I chose to whip up latest React App by typing in terminal:
  npx create-react-app gyphy-app

User will need to put their own APIKEY into the config file:
  const APIKEY = "PUT-YOUR-API-KEY-HERE";
Developers can get an APIKEY here: https://developers.giphy.com/dashboard/?create=true


###  I left the Create React App README text below:::
